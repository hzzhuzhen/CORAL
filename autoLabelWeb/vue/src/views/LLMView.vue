  ...
  <div class="row whole-div">
    ...
    <div class="col-md-4 border-end position-relative">
      ...
      <div style="margin-top: 2px;">
        <img src="../../images/llm.png" width="300" alt="no pic">
      </div>
      <!--      组件-->
...
<!--              &lt;!&ndash; {{ scope.row.LLMLabel === 0 ? 'neg' : 'pos' }} &ndash;&gt;-->
<!--            </div>-->
<!--          </template>-->
<!--        </el-table-column>-->
<!--      </el-table>-->
...
<!--        &lt;!&ndash; <button id="NextPage" class="blue-button">-->
<!--                Next-->
<!--            </button> &ndash;&gt;-->
...
import TableDataProgress from "@/components/TableDataProgress.vue";
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      //       const ttpp = response.data.filterResult;
      ...
      //       let idx = 0;
      //       while (idx < 200) {
      //         const confidencePercentage = (parseFloat(ttpp[idx].confidence) * 100).toFixed(2) + "%";
      //         console.log(ttpp[idx].confidence);
      //         ttpp[idx].confidence = confidencePercentage;
      //         tableData.value.push(ttpp[idx]);
      //         idx++;
      //         if (idx === ttpp.length - 1) {
      //           break;
      //         }
      //       }
      //       const updateColumn2 = () => {
      //         if (index < 200 && index < tableData.value.length) {
      //           // console.log(labelMap[tableData.value[index].LLMLabel]);
      //           // if (tableData.value[index].LLMLabel == -1) tableData.value[index].LLMLabel = 0;
      //           if (tableData.value[index].LlmLabel === -1) tableData.value[index].LlmLabel = 0;
      //           // console.log(tableData.value[index].LLMLabel);
      ...
      //       };
      //       updateColumn2Interval = setInterval(updateColumn2, interval);
      //       const updateper = () => {
      //         percentage.value = Math.min(parseFloat((percentage.value + 1.15).toFixed(2)), 100);
      //       };
      //       updateperInterval = setInterval(updateper, interval);
      //     })
      //     .catch(error => {
      //       console.error(error);
      //     });
    ...
    onBeforeUnmount(() => {
      ...
      clearInterval(updateperInterval);
    });
